    ...
    return (
        <div className='text-white'>
            ...
            <div className='sm:p-20 p-5 sm:mt-[10%] mt-[130px] absolute w-full'>
                ...
                >Sponsor Us</h1>
                <h1 className='text-[#5f5f5f]'>Hi, I'm Esan Samuel,a problem solving full-stack developer skilled in React,TypeScript,Firebase,Tailwind,Node js and Solidity. I built this project to solve the problem I had in transferring a file from one device to another.
</h1>
